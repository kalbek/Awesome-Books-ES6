...
**Awesome Books ES6** is a JavaScript project at microverse

## 🛠 Built With <a name="built-with"> HTML CSS & Java Script (ES6)</a>

### Tech Stack <a name="tech-stack"></a>

> HTML CSS & Java Script(ES6)
...
- **Adds book title to books lists and displays on browser**
- **Adds book author to books lists and displays on browser**
- **Removes a book when remove button is clicked**
- **Stores data on web browser**
...
git clone https://github.com/kalbek/Awesome-Books.git
